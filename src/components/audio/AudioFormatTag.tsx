...
function LosslessWaveformGlyph() {
  // Apple Lossless mark — the canonical glyph. fill="currentColor" so the
  // mark inherits the pill's text colour and stays in the project's grey
  // palette without an off-brand accent.
  return (
    <svg
      width="15"
      height="9"
